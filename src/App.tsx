...
import UserAuthorizationConfirmation from "./pages/UserAuthorization-Confirmation";
        ...
        <Routes>
          <Route element={<MainLayout />}>
            ...
            <Route
              ...
              element={<UserAuthorizationLogin />}
            />
            <Route
              path="/user-authorization/form"
              element={<UserAuthorizationForm />}
            />
            <Route
              path="/user-authorization/confirmation"
              element={<UserAuthorizationConfirmation />}
            />
            <Route path="/register" element={<AppShell />}>
              <Route
                index
                element={<Navigate to="/register/business-info" replace />}
              />
